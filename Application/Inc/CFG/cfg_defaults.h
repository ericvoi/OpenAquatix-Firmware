...
#define MAX_MAX_TRANSDUCER_V              (142.0f)
...
#define MIN_TX_RX_CAPABLE                 (false)
#define MAX_TX_RX_CAPABLE                 (true)
...
#define DEFAULT_PREAMBLE_ERROR_BEHAVIOR   (PREAMBLE_ERROR_NOTIFY)
#define MIN_PREAMBLE_ERROR_BEHAVIOR       (0)
#define MAX_PREAMBLE_ERROR_BEHAVIOR       (NUM_PREAMBLE_ERROR_BEHAVIORS - 1)

#define DEFAULT_CARGO_ERROR_BEHAVIOR      (CARGO_ERROR_NOTIFY)
